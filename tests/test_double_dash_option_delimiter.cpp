...
// NOLINTNEXTLINE
TEST_CASE("structopt can parse the '--' delimiter as end of optional arguments in nested structs" *
		  test_suite("single_optional")) {
	{
		auto arguments = structopt::app("test").parse<CommandOptions>(std::vector<std::string>{
